...
[`drpcorg/method-specs`](https://github.com/drpcorg/method-specs), a Go module shared by several drpc services, and nodecore consumes it as a regular dependency:

| Import path | Contents |
| --- | --- |
| `github.com/drpcorg/method-specs/pkg/methods` | the spec JSON files (embedded), the loader (`NewMethodSpecLoader().Load()`) and the lookup helpers (`GetSpecMethod`, `IsSubscribeMethod`, ...) |
| `github.com/drpcorg/method-specs/pkg/sui` | generated `sui.rpc.v2` protobuf types used by the Sui gRPC connector and the [gRPC chain ingress](14-grpc-ingress.md) |
...
[`docs/method-specs.md`](https://github.com/drpcorg/method-specs/blob/main/docs/method-specs.md).

## Changing specs

1. Open a PR against [`drpcorg/method-specs`](https://github.com/drpcorg/method-specs) and get it released (a semver tag).
2. Bump the dependency here: `go get github.com/drpcorg/method-specs@<tag> && go mod tidy`.
