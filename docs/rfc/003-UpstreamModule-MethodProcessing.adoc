= RFC 003-UpstreamModule-MethodProcessing
...
* category - additional methods parameters
** type - a method protocol type (json-rpc, rest, grpc, etc)
** subscription - additional parameters of subscription methods
*** method - a "method" field in the json-rpc response
*** unsub - an unsubscribe method
