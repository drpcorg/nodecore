...
// FetchStellarHorizonHealth reads Horizon's GET /health. Horizon answers 503
// while unhealthy but still sends the health booleans, so an error response
// whose body parses as the health document is used as the answer; anything else
