...
func TestLiveLowerBoundFromPrunedErrorUpdatesProofBound(t *testing.T) {
	...
	bound, ok := liveLowerBoundFromPrunedError(request.Method().Name(), request.ParseParams(context.Background()), response, 300_000_000)
...
func TestLiveLowerBoundFromPrunedErrorSkipsNonPrunedErrorsBeforeParsingParams(t *testing.T) {
	...
	_, ok := liveLowerBoundFromPrunedError(request.Method().Name(), request.ParseParams(context.Background()), response, 300_000_000)
...
func TestLiveLowerBoundFromPrunedErrorSkipsFutureBlock(t *testing.T) {
	...
	_, ok := liveLowerBoundFromPrunedError(request.Method().Name(), request.ParseParams(context.Background()), response, 100_000_000)
...
func TestLiveLowerBoundFromPrunedErrorSkipsUnknownHead(t *testing.T) {
	...
	_, ok := liveLowerBoundFromPrunedError(request.Method().Name(), request.ParseParams(context.Background()), response, 0)
