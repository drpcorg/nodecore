...
func TestEvmLowerBoundDetectorSupportedTypesAndPeriod(t *testing.T) {
	...
	detectors := []struct {
		detector *lower_bounds.EvmLowerBoundDetector
		bt       protocol.LowerBoundType
	}{
		{lower_bounds.NewEvmStateLowerBoundDetector("id", evmChain(), time.Second, connector), protocol.StateBound},
		{lower_bounds.NewEvmBlockLowerBoundDetector("id", evmChain(), time.Second, connector), protocol.BlockBound},
		{lower_bounds.NewEvmTxLowerBoundDetector("id", evmChain(), time.Second, connector), protocol.TxBound},
		{lower_bounds.NewEvmReceiptsLowerBoundDetector("id", evmChain(), time.Second, connector), protocol.ReceiptsBound},
	}
...
func TestEvmStateLowerBoundDetectorFallsBackToBalanceWhenStateOverrideUnsupported(t *testing.T) {
	...
	detector := lower_bounds.NewEvmStateLowerBoundDetector("id", evmChain(), time.Second, connector)
...
func TestEvmTxLowerBoundDetectorChecksFirstTransactionHash(t *testing.T) {
	...
	detector := lower_bounds.NewEvmTxLowerBoundDetector("id", evmChain(), time.Second, connector)
...
func TestEvmReceiptsLowerBoundDetectorChecksFirstTransactionObjectHash(t *testing.T) {
	...
	detector := lower_bounds.NewEvmReceiptsLowerBoundDetector("id", evmChain(), time.Second, connector)
