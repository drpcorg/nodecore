...
func (e *EthCallLimitValidator) Validate() validations.ValidationSettingResult {
...
func NewEthCallLimitValidator(
	...
	return &EthCallLimitValidator{
		...
		chain:      chain,
		option:     options,
		executor:   validations.ValidatorExecutor(upstreamId, "ethCallLimitValidation", IgnoredCallLimitErrors),
	}
}

var _ validations.SettingsValidator = (*EthCallLimitValidator)(nil)
