...
func TestEthCallLimitValidatorReturnsFatalSettingErrorWhenReturnDataLimitIsTooLow(t *testing.T) {
	...
	validator := eth_validations.NewEthCallLimitValidator("upstream-1", connector, chain, options)
...
func newEthCallLimitConnectorMock(
	...
	isIgnored := lo.SomeBy(eth_validations.IgnoredCallLimitErrors, func(item string) bool {
