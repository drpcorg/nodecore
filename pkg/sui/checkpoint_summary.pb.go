...
const file_sui_rpc_v2_checkpoint_summary_proto_rawDesc = "" +
	"\n" +
	"#sui/rpc/v2/checkpoint_summary.proto\x12\n" +
	"sui.rpc.v2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14sui/rpc/v2/bcs.proto\x1a!sui/rpc/v2/gas_cost_summary.proto\x1a\x1asui/rpc/v2/signature.proto\"\x83\a\n" +
	...
	"\x0fprevious_digest\x18\a \x01(\tH\x06R\x0epreviousDigest\x88\x01\x01\x12c\n" +
	"\x1eepoch_rolling_gas_cost_summary\x18\b \x01(\v2\x1a.sui.rpc.v2.GasCostSummaryH\aR\x1aepochRollingGasCostSummary\x88\x01\x01\x12=\n" +
	"\ttimestamp\x18\t \x01(\v2\x1a.google.protobuf.TimestampH\bR\ttimestamp\x88\x01\x01\x12B\n" +
	"\vcommitments\x18\n" +
	" \x03(\v2 .sui.rpc.v2.CheckpointCommitmentR\vcommitments\x12J\n" +
	"\x11end_of_epoch_data\x18\v \x01(\v2\x1a.sui.rpc.v2.EndOfEpochDataH\tR\x0eendOfEpochData\x88\x01\x01\x127\n" +
	...
	"\x16_version_specific_data\"\x9b\x02\n" +
	"\x0eEndOfEpochData\x12V\n" +
	"\x14next_epoch_committee\x18\x01 \x03(\v2$.sui.rpc.v2.ValidatorCommitteeMemberR\x12nextEpochCommittee\x12B\n" +
	"\x1bnext_epoch_protocol_version\x18\x02 \x01(\x04H\x00R\x18nextEpochProtocolVersion\x88\x01\x01\x12M\n" +
	"\x11epoch_commitments\x18\x03 \x03(\v2 .sui.rpc.v2.CheckpointCommitmentR\x10epochCommitmentsB\x1e\n" +
	"\x1c_next_epoch_protocol_version\"\x93\x02\n" +
	"\x14CheckpointCommitment\x12R\n" +
	"\x04kind\x18\x01 \x01(\x0e29.sui.rpc.v2.CheckpointCommitment.CheckpointCommitmentKindH\x00R\x04kind\x88\x01\x01\x12\x1b\n" +
	"\x06digest\x18\x02 \x01(\tH\x01R\x06digest\x88\x01\x01\"v\n" +
	"\x18CheckpointCommitmentKind\x12&\n" +
	"\"CHECKPOINT_COMMITMENT_KIND_UNKNOWN\x10\x00\x12\x18\n" +
	"\x14ECMH_LIVE_OBJECT_SET\x10\x01\x12\x18\n" +
	"\x14CHECKPOINT_ARTIFACTS\x10\x02B\a\n" +
	"\x05_kindB\t\n" +
	"\a_digestB\x97\x01\n" +
	"\x0ecom.sui.rpc.v2B\x16CheckpointSummaryProtoP\x01Z#github.com/drpcorg/nodecore/pkg/sui\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
