...
const file_sui_rpc_v2_ledger_service_proto_rawDesc = "" +
	...
	"\n" +
	"ListEvents\x12\x1d.sui.rpc.v2.ListEventsRequest\x1a\x1e.sui.rpc.v2.ListEventsResponse0\x01B\x93\x01\n" +
	"\x0ecom.sui.rpc.v2B\x12LedgerServiceProtoP\x01Z#github.com/drpcorg/nodecore/pkg/sui\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
