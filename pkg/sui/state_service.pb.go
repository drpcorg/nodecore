...
const file_sui_rpc_v2_state_service_proto_rawDesc = "" +
	...
	"\abalance\x18\x03 \x01(\x04H\x01R\abalance\x88\x01\x01\x12,\n" +
	"\x0faddress_balance\x18\x04 \x01(\x04H\x02R\x0eaddressBalance\x88\x01\x01\x12&\n" +
	"\fcoin_balance\x18\x05 \x01(\x04H\x03R\vcoinBalance\x88\x01\x01B\f\n" +
	"\n" +
	"_coin_typeB\n" +
	"\n" +
	"\b_balanceB\x12\n" +
	"\x10_address_balanceB\x0f\n" +
	"\r_coin_balance\"\xf1\x01\n" +
	...
	"\fListBalances\x12\x1f.sui.rpc.v2.ListBalancesRequest\x1a .sui.rpc.v2.ListBalancesResponseB\x92\x01\n" +
	"\x0ecom.sui.rpc.v2B\x11StateServiceProtoP\x01Z#github.com/drpcorg/nodecore/pkg/sui\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
