...
const file_sui_rpc_v2_transaction_proto_rawDesc = "" +
	...
	"\tmin_epoch\x18\x03 \x01(\x04H\x02R\bminEpoch\x88\x01\x01\x12D\n" +
	"\rmin_timestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampH\x03R\fminTimestamp\x88\x01\x01\x12D\n" +
	"\rmax_timestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x04R\fmaxTimestamp\x88\x01\x01\x12\x19\n" +
	"\x05chain\x18\x06 \x01(\tH\x05R\x05chain\x88\x01\x01\x12\x19\n" +
	"\x05nonce\x18\a \x01(\rH\x06R\x05nonce\x88\x01\x01\x12N\n" +
	"\x11allowed_proposers\x18\b \x01(\v2\x1c.sui.rpc.v2.AllowedProposersH\aR\x10allowedProposers\x88\x01\x01\"y\n" +
	"\x19TransactionExpirationKind\x12'\n" +
	"#TRANSACTION_EXPIRATION_KIND_UNKNOWN\x10\x00\x12\b\n" +
	"\x04NONE\x10\x01\x12\t\n" +
	"\x05EPOCH\x10\x02\x12\x10\n" +
	"\fVALID_DURING\x10\x03\x12\f\n" +
	"\bVALIDITY\x10\x04B\a\n" +
	"\x05_kindB\b\n" +
	"\x06_epochB\f\n" +
	"\n" +
	"_min_epochB\x10\n" +
	"\x0e_min_timestampB\x10\n" +
	"\x0e_max_timestampB\b\n" +
	"\x06_chainB\b\n" +
	"\x06_nonceB\x14\n" +
	"\x12_allowed_proposers\"U\n" +
	"\x10AllowedProposers\x12\x19\n" +
	"\x05epoch\x18\x01 \x01(\x04H\x00R\x05epoch\x88\x01\x01\x12\x1c\n" +
	"\tproposers\x18\x02 \x03(\rR\tproposersB\b\n" +
	"\x06_epoch\"\xfa\a\n" +
	...
	"endOfEpoch\x12[\n" +
	"\x17randomness_state_update\x18\b \x01(\v2!.sui.rpc.v2.RandomnessStateUpdateH\x00R\x15randomnessStateUpdate\"\xd1\x02\n" +
	"\x04Kind\x12\x10\n" +
	...
	"\x12#\n" +
	"\x1fPROGRAMMABLE_SYSTEM_TRANSACTION\x10\vB\x06\n" +
	"\x04dataB\a\n" +
	"\x05_kind\"u\n" +
	...
	"\ftransactions\x18\x01 \x03(\v2%.sui.rpc.v2.EndOfEpochTransactionKindR\ftransactions\"\x9c\a\n" +
	...
	"\x15bridge_object_version\x18\x06 \x01(\x04H\x00R\x13bridgeObjectVersion\x12#\n" +
	"\fstorage_cost\x18\a \x01(\x04H\x00R\vstorageCost\"\x96\x03\n" +
	"\x04Kind\x12\x10\n" +
	...
	"\x12\x1b\n" +
	"\x17DISPLAY_REGISTRY_CREATE\x10\v\x12\x1e\n" +
	"\x1aADDRESS_ALIAS_STATE_CREATE\x10\f\x12\"\n" +
	...
	"_validatorB\v\n" +
	"\t_durationB\x91\x01\n" +
	"\x0ecom.sui.rpc.v2B\x10TransactionProtoP\x01Z#github.com/drpcorg/nodecore/pkg/sui\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
